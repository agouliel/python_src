...
my_embed_model = HuggingFaceEmbedding(model_name="BAAI/bge-small-en-v1.5") # this downloads stuff
...
prompt_last_part = f'give a full answer (including root cause, corrective actions with bullets and preventive actions with bullets) for the following observation: "{obs_str}"'
