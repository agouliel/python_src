...
llm = ChatTogether(
  together_api_key='59...', # https://python.langchain.com/docs/integrations/llms/together
...
messages = [
    (
        ...
        """Read through the entire transcript carefully.
           ...
           Extract and list the five most interesting or important points f\
rom the transcript. For each point: State the key idea in a clear and concise m\
anner.

        - Ensure your summary and key points capture the essence of the vid\
eo without including unnecessary details.
        - Use clear, engaging language that is accessible to a general audi\
ence.
        - If the transcript includes any statistical data, expert opinions,\
 or unique insights, prioritize including these in your summary or key points."\
"",
    ),
