...
class Product(Model):
    ...
    @classmethod
    def name_and_cpu(cls):
        return cls.name + ' ' + cls.cpu # the allowed calculations here are very limited

    def id_and_name(self):
        return str(self.id) + ' ' + self.name # here calculations are allowed normally
